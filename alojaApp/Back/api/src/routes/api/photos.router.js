...
// /api/photos/by-property/:propertyId
router.get("/by-property/:propertyId", PhotoController.byProperty);

// /api/photos/cover/:propertyId
router.get("/cover/:propertyId", PhotoController.cover);
